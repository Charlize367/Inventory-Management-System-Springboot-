...
public class GlobalExceptionHandler {
  @ExceptionHandler(ResourceNotFoundException.class)
    ...
    Sentry.withScope(scope -> {
      ...
      scope.setExtra("endpoint", webRequest.getDescription(false));
      scope.setExtra("http-method", Objects.requireNonNull(webRequest.getHeader("X-HTTP-Method-Override")));
      scope.setLevel(io.sentry.SentryLevel.ERROR);
      Sentry.captureException(resourceNotFound);
    });
    ...
    public ResponseEntity<Object> handleResourceAlreadyExistsException(ResourceAlreadyExistsException alreadyExistsException, WebRequest webRequest) {
      ...
      Sentry.withScope(scope -> {
        ...
        scope.setExtra("http-method", Objects.requireNonNull(webRequest.getHeader("X-HTTP-Method-Override")));
        scope.setLevel(io.sentry.SentryLevel.ERROR);
        Sentry.captureException(alreadyExistsException);
      });
