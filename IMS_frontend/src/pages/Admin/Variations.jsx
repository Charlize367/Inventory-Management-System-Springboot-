            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
                ...
                <div className="relative bg-gray-100 rounded-lg shadow-sm ">
                    ...
                    <form onSubmit={handleSubmit} className="p-4 md:p-5">
                            ...
                            {isEditing &&
                        <button type="submit" className="text-white inline-flex cursor-pointer items-center bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-1 mb-3 text-center">
                        ...
                        <div>
                            ...
                            className="text-white inline-flex items-center ml-5 bg-gray-700 cursor-pointer hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 text-center"
                        >
                            Remove Option
                        </button>
                            </div>
            ...
            <div className="relative p-4 w-full max-w-md max-h-full">
                ...
                <div className="relative bg-gray-100 rounded-lg shadow-sm ">
                    ...
                    <div className="flex items-center justify-between p-4 md:p-5 rounded-t dark:border-gray-600 border-gray-100">
                        ...
                        <button type="button" onClick={closeAndClearForm2} className="text-gray-400 cursor-pointer bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                            <svg className="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                            </svg>
                            <span className="sr-only">Close modal</span>
                    ...
                    <form onSubmit={handleSubmit2} className="p-4 md:p-5">
                        ...
                        {isEditing2 &&
                        <button type="submit" className="text-white inline-flex items-center cursor-pointer bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-1 mb-3 text-center">
                            <svg className="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"></path></svg>
                           Update
                        </button>
                        }
